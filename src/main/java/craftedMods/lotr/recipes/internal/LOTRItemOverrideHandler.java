...
public class LOTRItemOverrideHandler implements ItemOverrideHandler
{
    ...
    public Map<ItemStack, String> getItemOverrideNames ()
    {
        ...
        this.addOverride (LOTRMod.utumnoReturnPortal,
            StatCollector.translateToLocal ("neiLotr.override.utumnoReturnPortal.name"));
        this.addOverride (LOTRMod.utumnoReturnPortalBase,
            StatCollector.translateToLocal ("neiLotr.override.utumnoReturnPortalBase.name"));
