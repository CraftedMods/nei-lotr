...
public class NEIExtensions {
	...
	public void onPreInit(FMLPreInitializationEvent event) throws IOException {
		...
		try {
			this.addonDir = new File(Minecraft.getMinecraft().mcDataDir.getPath() + File.separator + NEIExtensions.ADDON_DIR_NAME);
		...
		try {
			this.recipeCache = new File(this.addonDir.getPath() + File.separator + NEIExtensions.RECIPE_CACHE_FILE_NAME);
	...
	public void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent event) {
		if (event.modID.equals(NEIExtensions.MODID)) this.config.update();
	}
